...
export async function fetchAccounts(selectedNetwork: Network, thisWeb3Enable: typeof web3Enable, thisWeb3Accounts: typeof web3Accounts, apiPromise: ApiPromise) {
    console.log("fetchAccounts() - ", selectedNetwork);
    let selectedNetworkInfo = networkToInfo[selectedNetwork];
